...
!function (a, b) {
        ...
        var c = a.document, d = a.navigator, e = a.location, f = function () {
                ...
                var h, A, B, C, e = function (a, b) {
                        ...
                        }, f = a.jQuery, g = a.$, i = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, j = /\S/, k = /^\s+/,
                        l = /\s+$/, m = /\d/, n = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, o = /^[\],:{}\s]*$/,
                        ...
                        F = Array.prototype.push, G = Array.prototype.slice, H = String.prototype.trim,
        ...
        var w = /\.(.*)$/, x = /^(?:textarea|input|select)$/i, y = /\./g, z = / /g, A = /[^\w\s.|`]/g,
                B = function (a) {
                        return a.replace(A, "\\$&")
                };
        f.event = {
                ...
                "remove": function (a, c, d, e) {
                        if (3 !== a.nodeType && 8 !== a.nodeType) {
                                d === !1 && (d = C);
                                var g, h, j, l, m, n, o, p, q, r, k = 0, s = f.hasData(a) && f._data(a),
                                        t = s && s.events;
        ...
        var N = /Until$/, O = /^(?:parents|prevUntil|prevAll)/, P = /,/, Q = /^.[^:#\[\.,]*$/,
                R = Array.prototype.slice, S = f.expr.match.POS,
        ...
        var W = / jQuery\d+="(?:\d+|null)"/g, X = /^\s+/,
                Y = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Z = /<([\w:]+)/,
                $ = /<tbody/i, _ = /<|&#?\w+;/, ab = /<(?:script|object|embed|option|style)/i,
                bb = /checked\s*(?:[^=]|=\s*.checked.)/i, cb = /\/(java|ecma)script/i, db = /^\s*<!(?:\[CDATA\[|\-\-)/,
                eb = {
                ...
                "clone": function (a, b, c) {
                        ...
                        for (var i, k, h = [], j = 0; null != (k = a[j]); j++) if ("number" == typeof k && (k += ""), k) {
                                if ("string" == typeof k) if (_.test(k)) {
                                        k = k.replace(Y, "<$1></$2>");
                                        var l = (Z.exec(k) || ["", ""])[1].toLowerCase(), m = eb[l] || eb._default,
                                                n = m[0], o = b.createElement("div");
        ...
        var Rb, Sb, zb = /%20/g, Ab = /\[\]$/, Bb = /\r?\n/g, Cb = /#.*$/, Db = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
                ...
                Ib = /\?/, Jb = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Kb = /^(?:select|textarea)/i,
                Lb = /\s+/, Mb = /([?&])_=[^&]*/, Nb = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, Ob = f.fn.load,
                Pb = {}, Qb = {}, Tb = ["*/"] + ["*"];
        try {
                Rb = e.href
        } catch (Ub) {
        ...
        Sb = Nb.exec(Rb.toLowerCase()) || [], f.fn.extend({
                ...
                "ajax": function (a, c) {
                        ...
                        var k, n, o, p, q, r, t, u, d = f.ajaxSetup({}, c), e = d.context || d,
                                ...
                                i = f._Deferred(), j = d.statusCode || {}, l = {}, m = {}, s = 0, v = {
        ...
        f.fn.offset = "getBoundingClientRect" in c.documentElement ? function (a) {
                ...
                "initialize": function () {
                        ...
                        var m, n, e = f(a), g = e.offset(), h = f.css(a, "top"), i = f.css(a, "left"),
                                j = ("absolute" === d || "fixed" === d) && f.inArray("auto", [h, i]) > -1, k = {},
                                l = {};
